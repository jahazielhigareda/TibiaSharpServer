...
ALTER TABLE "PlayerVips" ADD "Description" text;

ALTER TABLE "PlayerVips" ADD "IconId" integer NOT NULL DEFAULT 0;

ALTER TABLE "PlayerVips" ADD "NotifyLogin" boolean NOT NULL DEFAULT FALSE;
...
ALTER TABLE "RuleViolationReports" ADD "StatmentIPAddress" character varying(255) NOT NULL DEFAULT '';

ALTER TABLE "Guilds" ALTER COLUMN "MessageOfTheDay" TYPE character varying(255);

ALTER TABLE "GuildMembers" ALTER COLUMN "RankName" TYPE character varying(255);
UPDATE "GuildMembers" SET "RankName" = '' WHERE "RankName" IS NULL;
ALTER TABLE "GuildMembers" ALTER COLUMN "RankName" SET NOT NULL;
ALTER TABLE "GuildMembers" ALTER COLUMN "RankName" SET DEFAULT '';

ALTER TABLE "GuildInvitations" ALTER COLUMN "RankName" TYPE character varying(255);
UPDATE "GuildInvitations" SET "RankName" = '' WHERE "RankName" IS NULL;
ALTER TABLE "GuildInvitations" ALTER COLUMN "RankName" SET NOT NULL;
ALTER TABLE "GuildInvitations" ALTER COLUMN "RankName" SET DEFAULT '';
...
CREATE TABLE "RuleViolations" (
    ...
    "Comment" character varying(255) NOT NULL,
    "StatmentPlayerId" integer,
    "Statment" character varying(255),
    "StatmentDate" timestamp with time zone,
    "StatmentIPAddress" character varying(255) NOT NULL,
    "IPAddressBanishment" boolean NOT NULL,
    "CreationDate" timestamp with time zone NOT NULL,
