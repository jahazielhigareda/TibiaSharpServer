    ...
    public class ParseAnswerReportRuleViolationCommand : IncomingCommand
    {
        ...
        public override Promise Execute()
        {
            ...
            if (reporter != null)
            {
                ...
                {
                    Context.AddPacket(ruleViolation.Reporter, new ShowTextOutgoingPacket(Context.Server.Channels.GenerateStatementId(Player.DatabasePlayerId, Message, Player.Client.Connection.IpAddress), ruleViolation.Assignee.Name, ruleViolation.Assignee.Level, MessageMode.RVRAnswer, Message) );
