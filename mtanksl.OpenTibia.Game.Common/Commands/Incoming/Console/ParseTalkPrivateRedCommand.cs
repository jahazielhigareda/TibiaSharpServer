    ...
    public class ParseTalkPrivateRedCommand : IncomingCommand
    {
        ...
        public override Promise Execute()
        {
            ...
            if (Player.Rank == Rank.Gamemaster)
            {
                ...
                {
                    Context.AddPacket(observer, new ShowTextOutgoingPacket(Context.Server.Channels.GenerateStatementId(Player.DatabasePlayerId, Message, Player.Client.Connection.IpAddress), Player.Name, Player.Level, MessageMode.GamemasterPrivateFrom, Message) );
