...
namespace OpenTibia.Tests
{
    ...
    public class WrapItemChestHandlerTests
    {
        [TestMethod]
        public void CantWrapQuestChest()
        {
            Test.Run(t =>
            {
                ...
                t.Using(player, a => a
                    .Execute(new PlayerWrapItemCommand(a.Connection.Client.Player, item), new WrapItemChestHandler() )
                    .ExpectSuccess(false)
                    .Observe(o => o
                        .ExpectPacket(1)
